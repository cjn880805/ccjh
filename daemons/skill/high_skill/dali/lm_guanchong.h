//lm_guanchong.h  六脉神剑之右手无名指关冲剑

SKILL_BEGIN(CSlm_guanchong);

virtual void create()
{
	set_name( "六脉神剑之右手无名指关冲剑");
}
...
virtual CMapping * query_action(CChar * me)
{
	...
	struct {
		...
		{"$N一式「瑶台神游」，手上真气四射，右手无名指戳向$n的胸腹间", 60, -5, -5,10 , 0,"无形剑气","刺伤",},
		{"$N左掌护胸，一式「青溪水落」，无名指划了个半弧，猛地一甩，疾点$n的$l", 120, 5, 10, 20, 10,"无形剑气","刺伤",},
		{"$N身形闪动，一式「深山云雾」，无名指端部射出一股剑气，直射$n的要穴", 180, 10, 20, 30, 20,"无形剑气","刺伤",},
		{"$N盘膝跌坐，一式「平湖起澜」，左手握拳托肘，右手无名指遥遥对着$n一捺", 240, 20, 30, 40, 30,"无形剑气","刺伤",},
		{"$N忽地跃起，左掌抚胸，伸出右手无名指，一式「落水拍石」带着一种不可\n抵挡的气势缓缓向$n头顶百汇穴点去", 300, 30,40 , 50, 40,"无形剑气","刺伤",},
		{"$N一式「平水撼石」，出指舒缓自如，对着$n一捺", 360, 40, 50, 60,50 ,"无形剑气","刺伤",},
		{"$N手臂颤动，有如轻风吹过，一招「轻水飘絮」，拂遍$n全身诸穴", 420, 40, 50, 70,60 ,"无形剑气","刺伤",},
		{"$N倏忽之间欺近身去，一招「急水冲木」点向$n，一攻即退", 480, 60, 60,90 ,80 ,"无形剑气","刺伤",},
	};
   
	for(int i=8; i>0; i--)
	{
		if(action[i - 1].lvl < me->query_skill("lm_guanchong", 1))
		{
			int level = random(i);
