...
virtual void create()
{
	...
	set_skill("shedao_qigong", 250);		// 蛇岛气功
	set_skill("shenlong_xinfa", 250);		// 神龙心法
	set_skill("dodge", 250);			// 基本躲闪
	set_skill("yixingbu", 250);			// 意形步
	set_skill("shenlong_bashi", 250);		// 神龙八式
	set_skill("parry", 250);			// 基本招架
	set_skill("strike", 250);		        // 基本掌法
	set_skill("huagu_mianzhang", 250);		// 化骨绵掌
