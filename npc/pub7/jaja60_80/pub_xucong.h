...
LEV1_BEGIN(CNlev1_xucong);

virtual void create()
{
	set_name("虚冲道长", "xu cong");
	set("title", "无量寿佛");
	set("gender", "男性");
	set("age", 60);
	set("level", 100);
	...
	set_skill("taiji_shengong", 210+random(30));		// 太极神功
	set_skill("unarmed", 210+random(30));			// 基本拳脚
	set_skill("taiji_quan", 210+random(30));			// 太极拳
	set_skill("dodge", 210+random(30));			// 基本躲闪
	set_skill("tiyunzong", 210+random(30));			// 梯云纵
	set_skill("parry", 210+random(30));			// 基本招架
	set_skill("sword", 210+random(30));			// 基本剑法
	set_skill("taiji_jian", 210+random(30));			// 太极剑
