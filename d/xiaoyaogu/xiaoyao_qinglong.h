//xiaoyao_qinglong.h 青龙塔
//秦波 2002、12、5

XiaoYao_BEGIN(CRXiaoYao_qinglong);

virtual void create()
{
	set_name( "青龙塔");

	add_door("逍遥谷空地", "逍遥谷空地", "逍遥谷青龙塔");	
...
int do_jinru(CChar *me, char * arg)
{
	...
	if(me->query_temp("xy/renwu4_1"))
	{
		...
		Xy_Npc->move(load_room("逍遥谷青龙塔塔底11"));
