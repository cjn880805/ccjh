...
virtual void create()
{
	set_name("慕容重复", "murong fu");
	set("title","姑苏慕容公子");
	set("nick","以彼之道 还施彼身");
	set("long", 
		"他就是天下号称以彼之道，还彼之身的姑苏慕容重复。\n"
		"他脸上带着不可一世的笑容。\n");
	set("age", 27);
	...
	set_inquiry("名字", "我就是以彼之道，还施彼身的姑苏慕容重复。");
	set_inquiry("这里", "这里是大名鼎鼎的燕子坞，难道你没有听说过？");
	set_inquiry("传闻",  "家父突染恶疾，我连他老人家最后一面都没见到，此事顶有蹊跷！");
	set_inquiry("姑妈",  "我的姑妈住在曼佗罗山庄，那里有闻名天下的娘缳玉洞。");
/*
	set("inquiry", 
		([
		"还施水阁" : (: ask_ge :),
