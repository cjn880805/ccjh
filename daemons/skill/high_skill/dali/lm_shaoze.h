//lm_shaoze.h  六脉神剑之左手小指少泽剑

SKILL_BEGIN(CSlm_shaoze);

virtual void create()
{
	set_name( "六脉神剑之左手小指少泽剑");
}
...
virtual CMapping * query_action(CChar * me)
{
	...
	struct {
		...
		{"$N一式「碧草迎晨」，手上真气四射，左手小指戳向$n的胸腹间", 60,  -5,  -5, 10, 0, "无形剑气","刺伤",},
		{"$N左掌护胸，一式「独草迎风」，小指划了个半弧，猛地一甩，疾点$n的$l", 120, 5, 10 , 20,10 , "无形剑气","刺伤",},
		{"$N身形闪动，一式「山茶绽开」，小指端部射出一股剑气，直射$n的要穴", 180, 10,  20, 30, 20, "无形剑气","刺伤",},
		{"$N盘膝跌坐，一式「茶花夺日」，右手握拳托肘，左手小指遥遥对着$n一捺", 240, 20,  30, 40,30 , "无形剑气","刺伤",},
		{"$N忽地跃起，右掌抚胸，伸出左手小指，一式「百花齐放」带着一种不可\n抵挡的气势缓缓向$n头顶百汇穴点去", 300, 30,  40, 50, 40, "无形剑气","刺伤",},
		{"$N一式「只花争春」，出指舒缓自如，对着$n一捺", 360, 40,  50, 60,50 , "无形剑气","刺伤",},
		{"$N手臂颤动，有如轻风吹过，一招「草拢花拂」，拂遍$n全身诸穴", 420, 40,  50, 70, 60, "无形剑气","刺伤",},
		{"$N倏忽之间欺近身去，一招「百花突艳」点向$n，一攻即退", 480, 60,  60, 90, 80, "无形剑气","刺伤",},
	};
 
	for(int i=8; i>0; i--)
	{
		if(action[i - 1].lvl < me->query_skill("lm_shaoze", 1))
		{
			int level = random(i);
