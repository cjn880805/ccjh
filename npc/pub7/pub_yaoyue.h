...
virtual void create()
{
	...
	set_skill("shedao_qigong", 270);		// 蛇岛气功
	set_skill("shenlong_xinfa", 270);		// 神龙心法
	set_skill("dodge", 270);			// 基本躲闪
	set_skill("yixingbu", 270);			// 意形步
	set_skill("shenlong_bashi", 270);		// 神龙八式
	set_skill("parry", 270);			// 基本招架
	set_skill("strike", 270);		        // 基本掌法
	set_skill("huagu_mianzhang", 270);		// 化骨绵掌
