...
virtual void create()
{
	static struct{
		...
		{"独孤六衽", "duguliuren", taoist_with_sword, 0,},
		{"公输索", "gongshusuo", taoist_with_sword, 8,},
		{"南郭离",	"nanguoli", taoist_with_sword, 16,},
		{"公孙咎丘", "gongsunjiuqiu", taoist_with_sword, 24,},
		{"王孙须燮",	"wangsunxuxie", taoist_with_sword, 32,},
		{"南宫班",	"nangongban", taoist_with_sword, 40,},
		{"公羊度", "gongyangdu", taoist_with_sword, 48,},
		{"西门松",	"ximensong", taoist_with_sword, 56,},
		{"东园望", "dongyuanwang", taoist_with_sword, 61,},
		{"北邙歧", "beimangqi", taoist_with_sword, 66,},
		};
...
void do_copyme(CChar * ob)
{
	...
	set_skill("taiji_shengong", 50+i*3);
	set_skill("dodge", 50+i*3);
	set_skill("tiyunzong", 50+i*3);
	set_skill("unarmed", 50+i*3);
	set_skill("taiji_quan", 50+i*3);
	set_skill("parry", 50+i*3);
	set_skill("sword", 50+i*3);
	set_skill("taiji_jian", 50+i*3);
	set_skill("blade", 50+i*3);
	set_skill("taiji_dao", 50+i*3);
	set_skill("taoism", 50+i*3);
