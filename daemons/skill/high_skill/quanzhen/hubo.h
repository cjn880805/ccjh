...
{
	if( me->query("int") > 20 )
		return notify_fail("你思灵巧无法领悟互搏真谛。");
...
virtual CMapping * query_action(CChar * me)
{
	...
	for(int i=10; i>0; i--)
	{
		if(action[i - 1].lvl < me->query_skill("hubo", 1))
		{
			level = random(i);
...
virtual int practice_skill(CChar * me)
{
    ...
    case 0:
		...
		break;
    case 1:
		me->add("sk_exp", - random( me->query_con() +  me->query_skill("hubo",1) )/20);
		me->add("combat_exp", random( me->query_con() +  me->query_skill("hubo",1) )/10);
...
{
	return (combo == "haotian_zhang" || combo == "shexing_diaoshou" || combo == "wuluo_zhang"
		|| combo == "jinyu_quan" || combo == "tiangang_zhi" || combo == "jinding_zhang"
		|| combo == "xianglong_zhang" || combo == "anranxiaohun_zhang" || combo == "meinv_quan");
		|| combo == "wudu_shenzhang" || combo == "poyu_quan" || combo == "hunyuan_zhang"
		|| combo == "zhemei_shou" || combo == "liuyang_zhang" || combo == "xuantian_zhi"
		|| combo == "yingzhua_shou" || combo == "hanbing_mianzhang" || combo == "houquan"
		|| combo == "hanbing_strike" || combo == "sougu" || combo == "kongming_quan" 
		|| combo == "huagu_mianzhang" || combo == "shenlong_bashi" || combo == "lanhua_shou"
		|| combo == "xuanfeng_leg" || combo == "luoying_shenzhang" || combo == "taiji_quan"
		|| combo == "chousui_zhang" || combo == "xingxiu_duzhang" || combo == "yujiamu_quan"
		|| combo == "dashou_yin" || combo == "yunlong_zhua" || combo == "yunlong_shou"
		|| combo == "banruo_zhang" || combo == "sanhua_zhang" || combo == "qianye_shou"
		|| combo == "nianhua_zhi" || combo == "luohan_quan" || combo == "jingang_quan"); 
}*/
