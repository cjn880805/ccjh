...
//Sample for room:  明教秘道3

//coded by cat
//data: 2001-3-20

ROOM_BEGIN(CRMingJiao_md3);
...

{
	...
	CDoor * door = add_door("明教秘道1", "明教秘道1", "明教秘道3");//上
	door->set_name( "秘道");

	door = add_door("明教秘道6", "明教秘道6", "明教秘道3");//下
	door->set_name( "秘道");

	door = add_door("明教秘道7", "明教秘道7", "明教秘道3");//左
	door->set_name( "秘道");

	door = add_door("明教秘道8", "明教秘道8", "明教秘道3");//右
	door->set_name( "秘道");
};
