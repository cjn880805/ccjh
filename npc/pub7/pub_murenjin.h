...
virtual void create()
{
	...
	set_skill("zixia_shengong", 290);		// 紫霞神功
	set_skill("strike", 290);			// 基本掌法
	set_skill("hunyuan_zhang", 290);		// 混元掌
	set_skill("dodge", 290);			// 基本躲闪
	set_skill("huashan_shenfa", 290);		// 华山身法
	set_skill("parry", 290);			// 基本招架
	set_skill("sword", 290);		        // 基本剑法
	set_skill("huashan_sword", 290);		// 华山剑法
