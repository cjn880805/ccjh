...
CMapping * query_action(CChar * me)
{
	...
	static struct {
		...
		{"$n一式「一苇渡江」，前后脚脚尖脚跟相靠，身体如行云流水般滑出丈余。", 5,},
		{"$n一式「雨燕掠波」，双臂前伸，全身贴地平飞，顿时闪过了$N的凌厉攻势。", 10,},
		{"$n一式「移步换形」，足不动，手不抬，一转眼间便绕到了$N的身后。", 5,},
		{"$n一式「风驰电掣」，双脚点地，全身一道闪电，急速绕着$N飞奔。", 10,},
		{"$n一式「孤骛落日」，全身笔直，拔地而起，在半空中一转，已落到几丈远的地方。", 10,},
		{"$n一式「鸿雁双飞」，两臂鹏举如翼，在剌剌风声中，从$N头顶横跃而过。", 10,},
		{"$n一式「苍龙出水」，双脚点地，全身化为一道白影，急速绕着$N打了几转。", 20,},
		{"$n一式「稚凤归巢」，身体如陀螺般急转，气流形成一个个漩涡，令$N陷身其间，动弹不得。", 30},
	};
