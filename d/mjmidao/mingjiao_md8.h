...
//Sample for room:  明教秘道8

//coded by cat
//data: 2001-3-20

ROOM_BEGIN(CRMingJiao_md8);
...

{
	...
	CDoor * door =	add_door("明教秘道6", "明教秘道6", "明教秘道8");//上
	door->set_name( "秘道");

	door = add_door("明教秘道5", "明教秘道5", "明教秘道8");//下
	door->set_name( "秘道");

	door = add_door("明教秘道4", "明教秘道4", "明教秘道8");//左
	door->set_name( "秘道");

	door = add_door("明教秘道3", "明教秘道3", "明教秘道8");//右
	door->set_name( "秘道");
