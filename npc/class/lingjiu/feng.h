...
NPC_BEGIN(CNlingjiu_feng);

virtual void create()
{
	set_name("冯奶奶", "feng nana");
	set("long", "她是「灵鹫宫」九天九部中玄天部的首领。她跟随童姥多年, 出生入死,饱经风霜。");
	set("gender", "女性");
	set("per", 23);
	set("age", 60);
...
virtual void init(CChar * me)
{
	...
	{
		if(me->query_temp("lj/dating")&& !me->query_temp("lj/hm/冯奶奶"))
		{
			me->add_temp("lj/humang",1);
			me->add_temp("lj/hm/冯奶奶",1);
			tell_object(me, "冯奶奶惶惶茫茫的问道:主人失踪了！你看到主人了么?");
		}
