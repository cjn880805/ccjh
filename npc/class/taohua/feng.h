...
NPC_BEGIN(CNtaohua_feng);

virtual void create()
{
	set_name("冯沉风" , "feng chenfeng");
	set("gender", "男性");
	set("age", 39);
	set("long", "冯沉风是黄药师最小的一个徒弟，他的根基不错，但性子较为愚鲁。他的基本功扎实，一副忠厚老实的样子。");
	...
	set_skill("luoying_shenzhang", 120);     // 落英神剑掌
	set_skill("xuanfeng_leg", 120);      // 旋风扫叶腿
	set_skill("bibo_shengong", 120);     // 碧波神功
	set_skill("luoying_shenjian", 120);  // 落英神剑
...
virtual char * chat_msg()
{
	...
	{
	case 0:
		return "冯沉风说道：“师父疼爱小师妹，他的软猬甲一直由小师妹穿着。”";
	case 1:
        return "冯沉风自言自语地说道：“这个桃花阵，嗨，不简单！”";
	}
