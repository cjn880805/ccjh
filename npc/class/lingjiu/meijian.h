...
NPC_BEGIN(CNlingjiu_meijian);

virtual void create()
{
	set_name("剑梅", "jian mei");
...
virtual void init(CChar * me)
{
	...
	{
		if(me->query_temp("lj/dating") &&!me->query_temp("lj/hm/剑梅"))
		{
			me->add_temp("lj/humang",1);
			me->add_temp("lj/hm/剑梅",1);
			tell_object(me, "剑梅惶惶茫茫的问道:主人失踪了！你看到主人了么?");
		}
