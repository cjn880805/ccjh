...
{
	static char guo[22][20]={"西瓜","香瓜","柚子","橙子","桔子","番木瓜","木瓜","白兰瓜","火龙果","苹果","椰子","石榴","榴莲","芒果","菠萝","柠檬","橄榄","水蜜桃","哈蜜瓜","黄瓜","番茄","柿子"};
	static char guo1[8][20]={"李子","青梅","樱桃","杨梅","荔枝","香蕉","葡萄","草莓"};
	...
	char msg[255];
	set("long",snprintf(msg, 255,"这是一%s新鲜的「%s」",querystr("unit"),querystr("name")));
	set_weight(20000);
...
virtual int do_use(CChar * me, CContainer * who)
{
	if(who == me)
	{
		...
		if(me->query("yuandna/guo/count")>20)
			return notify_fail("美味虽丰，怎奈你食量有限，再也无法多吃一点了。");

		me->add("yuandna/guo/count",1);
