//xiaoyao_xuanwu35.h 玄武塔三层
//秦波 2002、12、17

XiaoYao_BEGIN(CRXiaoYao_xuanwu35);

virtual void create()
{
	set_name( "玄武塔三层");
	
	add_door("玄武塔三层4", "逍遥谷玄武塔三层34", "逍遥谷玄武塔三层35");
	
	add_door("玄武塔四层", "逍遥谷玄武塔四层41", "逍遥谷玄武塔二层35");
...
{
	if(me->query_temp("xy/ta/玄武/4")!=query("count") )
	{
	...
	else
	{
		...
		if(me->query_temp("xy/renwu4_1"))
		{
			...
			if(XyNpc)
			{
				...
				XyNpc->move(load_room("逍遥谷玄武塔四层41"));
			}
		}
	}
	return 1;
...
int valid_leave(CChar * me, const char * dir)
{
	if(userp(me))
	{
		...
		if(me->query_temp("xy/ta/玄武/4")!=query("count") && EQUALSTR(dir,"玄武塔四层"))
		{
