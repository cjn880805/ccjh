...
virtual void create()
{
	...
	set_skill("hunyuan_yiqi", 270);			// 混元一气功
	set_skill("claw", 270);				// 基本爪法
	set_skill("longzhua_gong", 270);		// 龙爪功
	set_skill("dodge", 270);			// 基本躲闪
	set_skill("shaolin_shenfa", 270);		// 少林身法
	set_skill("parry", 270);			// 基本招架
	set_skill("cuff", 270);				// 基本拳法
	set_skill("jingang_quan", 270);			// 大金刚拳
