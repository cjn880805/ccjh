...
//Sample for room:  明教秘道6

//coded by cat
//data: 2001-3-20

ROOM_BEGIN(CRMingJiao_md6);
...

{
	...
	CDoor * door = add_door("明教秘道2", "明教秘道2", "明教秘道6");//上
	door->set_name( "秘道");

	door = add_door("明教秘道1", "明教秘道1", "明教秘道6");//下
	door->set_name( "秘道");

	door = add_door("明教秘道8", "明教秘道8", "明教秘道6");//左
	door->set_name( "秘道");

	door = add_door("明教秘道7", "明教秘道7", "明教秘道6");//右
	door->set_name( "秘道");
