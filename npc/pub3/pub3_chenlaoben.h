...
virtual void create()
{
	...
	set("chat_chance", 5);
    set_inquiry("利息","想要利息先入会！");
	set_inquiry("陈远北","想见总舵主可没那么容易。");
	set_inquiry("天地会","只要是英雄好汉，都可以入我天地会。");
	set_inquiry("加入","只要入了我天地会，可以向会中各位好手学武艺。");
...
virtual char * chat_msg(CChar * player)
{
	...
	{
	case 0:
		return "我叫陈老本，就是因为做生意连老本也赔了。";
	case 1:
		return "在本店存钱利息至少百分之一，客官您只管存吧。";
	case 2:
		return "只有对本派弟子我才这么客气，对别的人啊，哼哼......";
	case 3:
		return "江湖威望很重要，威望值高大有好处啊。";
	case 4:
		return "五人分开一首诗，身上洪英无人知。";
	}
	return "";
}
...
say("\n陈老本说：如果你威望值很高，有些人见了你不但不会杀你，还会教你武功，送你宝贝。\n"
+"而且你还可以加入帮会，率领会众去攻打目标，就连去钱庄取钱也会有利息 。。。。。\n");
say("陈老本又说：杀某些坏人或救某些好人可以提高江湖威望。\n");
return 1;
}*/
/*
void enough_rest()
