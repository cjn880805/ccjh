...
*/
	set_inquiry("画", "这是二瞻先生的丹青。");
	set_inquiry("二瞻", "他乃是当今一位大画家。");
	set_inquiry("查士标", "二瞻先生有位本家伊璜先生牵连在这场‘明史’大案中。");
	set_inquiry("伊璜", "查伊璜, 也就是查继佐, 因大力将军所助, 免罪不究。");
	set_inquiry("力大", "大力将军乃广东提督吴六怪将军。");
	set_inquiry("吴六怪", "吴六怪将军身在曹营心在汉, 实际上是天地会洪顺堂香主。");
	set_inquiry("天地会", "天地会是台湾国姓爷延平郡王郑成功手下谋主陈永丽所创。");
	set_inquiry("陈永丽", "陈先生暗中联络老兄弟，胸口所刺八字便是会里的口号。");		
	set_inquiry("口号", "天地父母，反清复明。");
	set_inquiry("反清复明", "你也要学一学当年岳武穆尽忠报国, 刺字以决你心? ");
...
virtual char * chat_msg()				//NPC自动聊天
{
	...
	{
	case 0:
		return 	"顾炎武高声呤道：清风虽细难吹我，明月何尝不照人？ 真是绝唱！ ";
	case 1:
		return 	"顾炎武道：如此江山，沦于夷狄。我辈忍气吞声。偷生其间，实令人悲愤填膺。";
	case 2:
		return 	"顾炎武道：终有一日驱除胡虏，还我大汉河山，比之徒抒悲愤，更加令人气壮。";
	case 3:
		return 	"顾炎武道：当今之世，便真有桃源乐土，咱们也不能独善其身，去躲了起来。";
	}	
	return 0;
}
/*
