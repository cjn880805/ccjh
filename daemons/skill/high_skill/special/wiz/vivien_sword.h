...
int valid_force(const char * arg)
{
	...
	return notify_fail("薇安剑法必须与古墓独门内功玉女心法配合使用。");
}
...
virtual CMapping * query_action(CChar * me)
{
	...
	{"$N使一招「爱的真谛」，手中$w如一条银蛇般刺向$n！",40, 200, 0,},
		{"$N使出薇安剑法中的「爱的力量」，剑光霍霍斩向$n！",40, 210, 10, },
		{"$N一招「刀光倩影」,手中$w化剑为刀砍向$n！", 35, 220, 20, },
		{"$N手中$w中宫直进，一式「情意绵绵」对准$n刺出一剑！", 35, 250, 40,},
		{"$N纵身一跃，手中$w一招「爱在心头」对$n斜刺一剑", 45, 260, 60, },
		{"$N的$w凭空一指，一招「爱来爱去」刺向$n！", 45, 280, 80, },
		{"$N手中$w向外一分，使一招「纯爱之剑」反手对准$n一剑刺去！", 35, 290, 100, },
		{"$N横剑上前，身形一转手中$w使一招「爱神之心」画出一道光弧刺向$n！", 55, 300, 120, },
		{"$N使出薇安剑法中的最高境界［相思无用］，脑中突然想起了倩影，手中的$w化作长虹闪电般的击向$n！", 50, 320, 140, },
		{"倩影一现，消失．．．．\n$w剑光消失，$N突然手中又一亮！\n$MAG相思无用第一式：江山一剑！", 120,110,0,},
		{"$w剑光消失，$N突然手中又一亮！\n$HIM相思无用第二式：海天一剑！", 120,120,0,},
		{"$w剑光消失，$N突然手中又一亮！\n$RED相思无用第三式：君子一剑！", 120,130,0,},
		{"$w剑光消失，$N突然手中又一亮！\n$HIC相思无用第四式：淑女一剑！", 120,140,0,},
		{"$w剑光消失，$N突然手中又一亮！\n$HIB相思无用第五式：秋水一剑！", 120,150,0,},
		{"$w剑光消失，$N突然手中又一亮！\n$HIR相思无用第六式：相思一剑！", 120,160,0,},
		{"$w剑光消失，$N突然手中又一亮！\n$HIY相思无用第七式：无用一剑！", 120,170,0,},
		{"$w剑光消失，$N突然手中又一亮！\n$BLU相思无用最后一式：倩影一剑！$GRN", 130,200,0,},
...
static int do_freeze(CChar * me, CContainer * ob)
{
	...
	if (DIFFERSTR(me->querystr("family/family_name"), "古墓派"))
		return notify_fail("你不是古墓派的弟子,无法体会到「相思无用」的无奈与寂寞。");

	if(target->query_temp("apply/no_相思无用")&& (random(2)||target->query("bigboss")))
	{
		char msg[255];
		message_vision(snprintf(msg, 255,"$N使出薇安剑法中的最高境界［相思无用］，脑中突然想起了倩影，手中的%s化作长虹闪电般的击向$n！",weapon->name(1)),me,target);
		return notify_fail(snprintf(msg, 255,"%s低头轻叹一声，不闪不避，%s一愣，默默停手。",target->name(1),me->name(1)));
	}
