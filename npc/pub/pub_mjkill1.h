...
virtual void create()
{
	static struct{
		...
		{"独孤六衽", "duguliuren", young_monk, 0,},
		{"公输索", "gongshusuo", young_monk, 8,},
		{"南郭离",	"nanguoli", young_monk, 16,},
		{"公孙咎丘", "gongsunjiuqiu", young_monk, 24,},
		{"王孙须燮",	"wangsunxuxie", young_monk, 32,},
		{"南宫班",	"nangongban", young_monk, 40,},
		{"公羊度", "gongyangdu", young_monk, 48,},
		{"西门松",	"ximensong", young_monk, 56,},
		{"东园望", "dongyuanwang", young_monk, 61,},
		{"北邙歧", "beimangqi", young_monk, 66,},
		};
...
void do_copyme(CChar * ob)
{
	...
	set_skill("buddhism", 50+i*3);
	set_skill("literate", 50+i*3);
	set_skill("blade", 50+i*3);
	set_skill("claw", 50+i*3);
	set_skill("club", 50+i*3);
	set_skill("cuff", 50+i*3);
	set_skill("dodge", 50+i*3);
	set_skill("finger", 50+i*3);
	set_skill("force", 50+i*3);
	set_skill("hand", 50+i*3);
	set_skill("parry", 50+i*3);
	set_skill("staff", 50+i*3);
	set_skill("strike", 50+i*3);
	set_skill("sword", 50+i*3);
	set_skill("whip", 50+i*3);

	set_skill("banruo_zhang", 50+i*3);
	set_skill("cibei_dao", 50+i*3);
	set_skill("damo_jian", 50+i*3);
	set_skill("fengyun_shou", 50+i*3);
	set_skill("fumo_jian", 50+i*3);
	set_skill("hunyuan_yiqi", 50+i*3);
	set_skill("jingang_quan", 50+i*3);
	set_skill("longzhua_gong", 50+i*3);
	set_skill("luohan_quan", 50+i*3);
	set_skill("nianhua_zhi", 50+i*3);
	set_skill("pudu_zhang", 50+i*3);
	set_skill("qianye_shou", 50+i*3);
	set_skill("sanhua_zhang", 50+i*3);
	set_skill("riyue_bian", 50+i*3);
	set_skill("shaolin_shenfa", 50+i*3);
	set_skill("weituo_gun", 50+i*3);
	set_skill("wuchang_zhang", 50+i*3);
	set_skill("xiuluo_dao", 50+i*3);
	set_skill("yingzhua_gong", 50+i*3);
	set_skill("yijinjing", 50+i*3);
	set_skill("yizhi_chan", 50+i*3);
	set_skill("zui_gun", 50+i*3);
