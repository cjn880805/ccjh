//GaoCang_mg_15.h 地狱第11层
//秦波 2004.12.27

YEWAIDOOR_BEGIN(CRGaoChang_mg_15);

virtual void create()			
{
	set_name("剥皮地狱");

	CDoor * a = add_yewaidoor("west", 16, 20);
	CDoor * b = add_yewaidoor("north", 16, 20);
	CDoor * c = add_yewaidoor("east", 16, 20);
	CDoor * d = add_yewaidoor("south", 16, 20);

	a->set_name("迷宫西");
	b->set_name("迷宫北");
	c->set_name("迷宫东");
	d->set_name("迷宫南");
	add_door("寒冰地狱", "高昌寒冰地狱", "高昌剥皮地狱");
	add_npc("dy_master");
