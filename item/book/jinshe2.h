...
ITEM_BEGIN(CIjinshe2);

//under, we will custom our item

virtual void create(int nFlag = 0)		//Call it when the item is created
{
	set_name( "「金蛇秘芨」中册");	//set item name
...
int do_du(CChar *me )
{
	...
	me->improve_skill("jinshe_zhui", me->query_skill("literate", 1)/3+1);
