...
void do_copyme(CChar * ob)
{
	...
	set_skill("vivien_sword", 50+i*3);
	set_skill("tangshoudao", 50+i*3);
	set_skill("guimei_shenfa",50+i*3);//
	set_skill("literate", 50+i*3);

	map_skill("force", "zixia_shengong");
	map_skill("dodge", "guimei_shenfa");
	map_skill("parry", "vivien_sword");
	map_skill("sword", "vivien_sword");
	map_skill("unarmed", "tangshoudao");

	prepare_skill("unarmed","tangshoudao");
}
