...
virtual void create()
{
	...
	set_skill("linji_zhuang", 280);			// 临济十二庄
	set_skill("strike", 280);			// 基本掌法
	set_skill("jinding_zhang", 280);		// 金顶绵掌
	set_skill("dodge", 280);			// 基本躲闪
	set_skill("zhutian_bu", 280);			// 诸天化身步
	set_skill("parry", 280);			// 基本招架
	set_skill("sword", 280);		        // 基本剑法
	set_skill("huifeng_jian", 280);			// 回风拂柳剑
