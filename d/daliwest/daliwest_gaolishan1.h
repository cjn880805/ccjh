...
//Sample for room: 高黎山东坡
//coded by zouwenbin
//data: 2000-11-24

ROOM_BEGIN(CRDaLiWest_gaolishan1);
...
//	add_npc("animal_shanyang");
	...
	add_door("大理城阿头部", "大理城阿头部", "大理城高黎山东坡");
	add_door("大理城高黎山密林", "大理城高黎山密林", "大理城高黎山东坡");

	set("long", "这里是高黎山的东坡，向东俯视奔淌而过的东泸水，远远眺望跨谷相对的碧罗雪山。此去再向西全是崇山峻岭，人烟稀少。山间林深兽多，乌夷族的猎人经常进山打猎。" );
};
