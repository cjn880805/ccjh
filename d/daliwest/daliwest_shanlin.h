...
virtual void create()			//Call it when Room Create
{
	...
	add_door("大理城河边", "大理城河边", "大理城山林");
	add_door("大理城葛鲁城", "大理城葛鲁城", "大理城山林");
	
	set("yao",1);

	set("long", "你走在一片茂密的山林中，时而有飞禽走兽横过，百鸟在林间飞鸣，南边乌夷部落里的村民经常来此狩猎。山林北面不远传来隆隆水声，看来有大河流过，南边是一片低洼的河谷盆地，颇有人烟。" );
};
