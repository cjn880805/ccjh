...
virtual void create()
{
	static struct{
		...
		{"白熏", "baixun", young_man2, 0,},
		{"明石", "mingshi", young_man3, 8,},
		{"杜孜","duzi", cateran, 16,},
		{"钱穆", "qianmu", banditi, 24,},
		{"高谦","gaoqian", cateran, 32,},
		{"孙密","sunmi", cateran, 40,},
		{"吴诅", "wuzhu", young_man4, 48,},
		{"郑起","zhengqi", cateran, 56,},
		{"冯风", "fengfeng", banditi, 61,},
		{"陈诚", "chencheng", young_man3, 66,},
		{"诸骸", "zhuhai", young_man5, 71,},
...
void do_copyme(CChar * ob)
{
	...
	set_skill("kurong_changong", 50+i*(lev+query("boss")));
	set_skill("tiannan_step", 50+i*(lev+query("boss")));
	set_skill("jinyu_quan", 50+i*(lev+query("boss")));
	set_skill("wuluo_zhang", 50+i*(lev+query("boss")));
	set_skill("duanjia_sword", 50+i*(lev+query("boss")));
	set_skill("sun_finger", 50+i*(lev+query("boss")));
	set_skill("lm_shangyang", 50+i*(lev+query("boss")));	
