...
NPC_BEGIN(CNcity2_dubi);

virtual void create()
{
	
	set_name("独臂神尼", "dubi shenni");
	set("gender", "女性");
	set("age", 44);
	set("str", 24);
	set("dex", 20);
	...
	set("long", "这是一位白衣女尼，手握拂尘，目视前方。一只长袖空空如也，显是断了一臂，尽管如此，仍然掩不住她迷人的风采。");
	...
	set_skill("dodge", 150);
	set_skill("parry", 90);
	set_skill("qiufeng_chenfa", 150);
	set_skill("shenxing_baibian", 150);
	map_skill("whip", "qiufeng_chenfa");
	map_skill("parry", "qiufeng_chenfa");
	...
	set("max_mp", 1500);
	set("mp_factor", 100);
	set_inquiry("珂珂" , "神尼叹了一口气，说道：她是我的得意弟子，人长得挺美，唉，只可惜被韦小宝骗去了。");
