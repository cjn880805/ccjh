...
//Sample for room: 碧罗山下
//coded by zouwenbin
//data: 2000-11-24

ROOM_BEGIN(CRDaLiWest_biluoshan);
...
virtual void create()			//Call it when Room Create
{
	...
	add_door("大理城易溪部", "大理城易溪部", "大理城碧罗山下");

	set("long", "此间正处碧罗山脚下，几层梯田沿山坡而上，土地看来一点也不肥沃，作物较稀疏。乌夷地区农业颇落后，行换季轮耕，村民在不同的季节耕作不同的田地，许多附近的梯田正荒芜着无人耕作。--大理城，西去则进入深山。由于接近大理中心，这条路修整的相当平整，尽管山势崎岖，行路并不困难。" );
};
