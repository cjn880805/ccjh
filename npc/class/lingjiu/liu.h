...
{
	set_name("刘姐", "liu jie");
	set("long", "她是「灵鹫宫」九天九部中幽天部的首领。她跟随童姥多年, 出生入死,饱经风霜。");
	set("gender", "女性");
	set("per", 23);
	set("age", 30);
...
virtual void init(CChar * me)
{
	...
	{
		if(me->query_temp("lj/dating")&&!me->query_temp("lj/hm/刘姐") )
		{
			me->add_temp("lj/humang",1);
			me->add_temp("lj/hm/刘姐",1);
			tell_object(me, "刘姐惶惶茫茫的问道:主人失踪了！你看到主人了么?");
		}
		if(DIFFERSTR(me->querystr("family/family_name"), "灵鹫宫") )
			message_vision ("刘姐对着$N笑了笑说：“你是来拜师的吧？拜我吧。”", me);
		else
			message_vision ("刘姐对着$N点了点头，轻轻一笑。", me);
	}
}
...
virtual void attempt_apprentice(CChar * me)
{
    ...
    {
 		say("刘姐瞪着你看了老关天才冒出一句话来：“本宫只收女弟子！”", me);
		SendMenu(me);
		return;
	}
