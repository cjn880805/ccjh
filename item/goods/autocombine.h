...
#define AUTOCOMBINE_BEGIN(item_name)	class item_name : public CIautocombine	{	public:	item_name(){};	virtual ~item_name(){};
#define AUTOCOMBINE_END		};

ITEM_BEGIN(CIautocombine);
