//xiaoyao_qinglong35.h 青龙塔三层
//秦波 2002、12、17

XiaoYao_BEGIN(CRXiaoYao_qinglong35);

virtual void create()
{
	set_name( "青龙塔三层");
	
	add_door("青龙塔三层4", "逍遥谷青龙塔三层34", "逍遥谷青龙塔三层35");
	
	add_door("青龙塔四层", "逍遥谷青龙塔四层41", "逍遥谷青龙塔二层35");
...
{
	if(me->query_temp("xy/ta/青龙/4")!=query("count") )
	{
	...
	else
	{
		...
		if(me->query_temp("xy/renwu4_1"))
		{
			...
			if(XyNpc)
			{
				...
				XyNpc->move(load_room("逍遥谷青龙塔四层41"));
			}
		}
	}
	return 1;
...
int valid_leave(CChar * me, const char * dir)
{
	if(userp(me))
	{
		...
		if(me->query_temp("xy/ta/青龙/4")!=query("count") && EQUALSTR(dir,"青龙塔四层"))
		{
