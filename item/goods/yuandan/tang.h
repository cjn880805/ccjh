...
{
	static char tang[5][20]={"荷叶膳粥","红枣粟米羹","莲子银耳羹","皮蛋瘦肉粥","火腿竹笙羹"};
	...
	set("long",snprintf(msg, 255,"这是一盆鲜美的「%s」",tang[index]));
...
virtual int do_use(CChar * me, CContainer * who)
{
	if(who == me)
	{
		...
		if(me->query("yuandna/tang/count")>10)
			return notify_fail("美味虽丰，怎奈你食量有限，再也无法多吃一点了。");
		me->add("yuandna/tang/count",1);
