...
//Sample for room: 黑木崖顶通道6层
//coded by zouwenbin
//data: 2000-11-16

ROOM_BEGIN(CRHeiMuYa_tongdao6);
...
virtual void create()			//Call it when Room Create
{
	...
	add_npc("heimuya_jiaotu6");
	add_npc("heimuya_jiaotu6");
	if(random(2))
		add_npc("heimuya_jiaotu6");


	add_door("黑木崖顶通道5层", "黑木崖顶通道5层", "黑木崖顶通道6层");
	add_door("花园", "黑木崖顶小花园", "黑木崖顶通道6层");


	set("long", "这里是通向黑木崖顶的最顶层通道，通道两旁站着几个日月神教的教徒，从他们的神色看来武功好象不错。");
