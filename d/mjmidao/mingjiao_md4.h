...
//Sample for room:  明教秘道4

//coded by cat
//data: 2001-3-20

ROOM_BEGIN(CRMingJiao_md4);
...

{
	...
	CDoor * door = add_door("明教秘道3", "明教秘道3", "明教秘道4");//上
	door->set_name( "秘道");

	door = add_door("明教秘道8", "明教秘道8", "明教秘道4");//下
	door->set_name( "秘道");

	door = add_door("明教秘道1", "明教秘道1", "明教秘道4");//左
	door->set_name( "秘道");

	door = add_door("明教秘道2", "明教秘道2", "明教秘道4");//右
	door->set_name( "秘道");
